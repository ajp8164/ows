...
We're working hard to make *bcccore* the most powerful JavaScript library for working with bitcoin. Our goal is to have *bcccore* be a library that can be used by anyone interested in bitcoin, and to level expertise differences with great design and documentation.

## Community

If there are any questions, etc., please feel to ask in one of the community channels:

- https://github.com/owstack/bcccore/issues (Issues)
...
#### T3 - Require 'bcccore' and Look up Classes from There
...
```sh
git remote add owstack git@github.com:owstack/bcccore.git
...
```
Finally go to [github.com/owstack/bcccore](https://github.com/owstack/bcccore) in your web browser and issue a new pull request.
...
[github.com/owstack/bcccore/issues](https://github.com/owstack/bcccore/issues).
